...
freq = float(s.readline())  # sampling rate
Fs = freq * 240
Ts = 1.0/Fs; # sampling interval
t = np.arange(0,1 / freq * 2,Ts) # time vector; create Fs samples between 0 and 1.0 sec.
y = np.arange(0,1 / freq * 2,Ts) # signal vector; create Fs samples
